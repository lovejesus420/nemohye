...
function WeddingTab({user}){
  ...
  return(<div>
    ...
    {view==='form'&&(<div>
      <div style={{background:'linear-gradient(135deg,#4a0e4e,#1a0a2e)',borderRadius:14,padding:'22px 24px',marginBottom:16,color:'#fff'}}><div style={{fontSize:11,letterSpacing:3,color:'#f9a8d4',textTransform:'uppercase',marginBottom:8}}>✦ AI 웨딩 플래너</div><div style={{fontFamily:'serif',fontSize:'1.32rem',fontWeight:700,marginBottom:6}}>예산에 맞는 완벽한 결혼식을<br/>설계해드립니다 💍</div><p style={{fontSize:13,color:'rgba(255,255,255,0.65)',lineHeight:1.7}}>스드메부터 웨딩홀, 신혼여행까지 — 준비 일정과 예산을 한 번에</p></div>
